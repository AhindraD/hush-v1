...
- **Agentic Yield:** A fully on-chain autonomous agent continuously monitors APY feeds and rebalances capital without relying on external cron jobs, maximizing returns for the DAF.
